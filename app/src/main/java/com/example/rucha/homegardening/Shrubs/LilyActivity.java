...
public class LilyActivity extends AppCompatActivity implements View.OnClickListener {
...
//        mImgbtnPrev.setVisibility(View.INVISIBLE);
    ...
    public void onClick(View view) {
        if (view == mImgbtnNext) {
            Intent intent = new Intent(LilyActivity.this, OrchidActivity.class);
            startActivity(intent);
        }
        if (view == mImgbtnPrev) {
            Intent intent = new Intent(LilyActivity.this, DahliaActivity.class);
            startActivity(intent);
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_home:
                Intent intenthome = new Intent(LilyActivity.this, MainActivity.class);
                startActivity(intenthome);
                break;
            case R.id.action_herb:
                Intent intentherb = new Intent(LilyActivity.this, HerbActivity.class);
                startActivity(intentherb);
                break;
            case R.id.action_shrub:
                Intent intentshrub = new Intent(LilyActivity.this, ShrubActivity.class);
                startActivity(intentshrub);
                break;
            case R.id.action_climber:
                Intent intentclimber = new Intent(LilyActivity.this, ClimberActivity.class);
