...
public class FlameVineActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_flame_vine);
...
//        mImgbtnPrev.setVisibility(View.INVISIBLE);
    ...
    public void onClick(View view) {
        if (view == mImgbtnNext) {
            Intent intent = new Intent(FlameVineActivity.this, LoofahActivity.class);
            startActivity(intent);
        }
        if (view == mImgbtnPrev) {
            Intent intent = new Intent(FlameVineActivity.this, ButterflyPeaActivity.class);
            startActivity(intent);
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_home:
                finish();
                Intent intenthome = new Intent(FlameVineActivity.this, MainActivity.class);
                startActivity(intenthome);
                break;
            case R.id.action_herb:
                finish();
                Intent intentherb = new Intent(FlameVineActivity.this, HerbActivity.class);
                startActivity(intentherb);
                break;
            case R.id.action_shrub:
                finish();
                Intent intentshrub = new Intent(FlameVineActivity.this, ShrubActivity.class);
                startActivity(intentshrub);
                break;
            case R.id.action_climber:
                finish();
                Intent intentclimber = new Intent(FlameVineActivity.this, ClimberActivity.class);
