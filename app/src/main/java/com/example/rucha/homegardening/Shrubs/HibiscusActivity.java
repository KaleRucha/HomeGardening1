...
//        mImgbtnPrev.setVisibility(View.INVISIBLE);
    ...
    public void onClick(View view) {
        if (view == mImgbtnNext) {
            Intent intent = new Intent(HibiscusActivity.this, JasmineActivity.class);
            startActivity(intent);
        }
        if (view == mImgbtnPrev) {
            Intent intent = new Intent(HibiscusActivity.this, RoseActivity.class);
            startActivity(intent);
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_home:
                Intent intenthome = new Intent(HibiscusActivity.this, MainActivity.class);
                startActivity(intenthome);
                break;
            case R.id.action_herb:
                Intent intentherb = new Intent(HibiscusActivity.this, HerbActivity.class);
                startActivity(intentherb);
                break;
            case R.id.action_shrub:
                Intent intentshrub = new Intent(HibiscusActivity.this, ShrubActivity.class);
                startActivity(intentshrub);
                break;
            case R.id.action_climber:
                Intent intentclimber = new Intent(HibiscusActivity.this, ClimberActivity.class);
