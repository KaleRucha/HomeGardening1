...
public class MorningGloryActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_morning_glory);
...
//        mImgbtnPrev.setVisibility(View.INVISIBLE);
    ...
    public void onClick(View view) {
        if (view == mImgbtnNext) {
            Intent intent = new Intent(MorningGloryActivity.this, StarJasmineActivity.class);
            startActivity(intent);
        }
        if (view == mImgbtnPrev) {
            Intent intent = new Intent(MorningGloryActivity.this, MoneyPlantActivity.class);
            startActivity(intent);
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_home:
                finish();
                Intent intenthome = new Intent(MorningGloryActivity.this, MainActivity.class);
                startActivity(intenthome);
                break;
            case R.id.action_herb:
                finish();
                Intent intentherb = new Intent(MorningGloryActivity.this, HerbActivity.class);
                startActivity(intentherb);
                break;
            case R.id.action_shrub:
                finish();
                Intent intentshrub = new Intent(MorningGloryActivity.this, ShrubActivity.class);
                startActivity(intentshrub);
                break;
            case R.id.action_climber:
                finish();
                Intent intentclimber = new Intent(MorningGloryActivity.this, ClimberActivity.class);
