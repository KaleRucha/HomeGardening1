...
public class NeriumOleanderActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nerium_oleander);
...
//        mImgbtnPrev.setVisibility(View.INVISIBLE);
    ...
    public void onClick(View view) {
        if (view == mImgbtnNext) {
            Intent intent = new Intent(NeriumOleanderActivity.this, FernActivity.class);
            startActivity(intent);
        }
        if (view == mImgbtnPrev) {
            Intent intent = new Intent(NeriumOleanderActivity.this, JasmineActivity.class);
            startActivity(intent);
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_home:
                Intent intenthome = new Intent(NeriumOleanderActivity.this, MainActivity.class);
                startActivity(intenthome);
                break;
            case R.id.action_herb:
                Intent intentherb = new Intent(NeriumOleanderActivity.this, HerbActivity.class);
                startActivity(intentherb);
                break;
            case R.id.action_shrub:
                Intent intentshrub = new Intent(NeriumOleanderActivity.this, ShrubActivity.class);
                startActivity(intentshrub);
                break;
            case R.id.action_climber:
                Intent intentclimber = new Intent(NeriumOleanderActivity.this, ClimberActivity.class);
